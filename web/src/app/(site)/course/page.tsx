    ...
    <div className="relative min-h-screen bg-paper py-10 sm:py-16">
      ...
      <Container className="relative z-10 max-w-5xl">
        <nav className="mb-6 text-sm text-muted" aria-label="Breadcrumb">
          ...
          <span className="text-ink-2">Complete Course</span>
        </nav>
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-5" id="enrollment">
              ...
              <div className="border-b border-line bg-sunken/60 p-6">
                ...
                {course.promo_code && course.discount_price && (
                  <p className="mt-1 text-xs text-brand-700 font-medium">
                    Use coupon <strong>{course.promo_code}</strong> for ₹{Math.max(0, Number(course.price) - Number(course.discount_price))} instant discount (Pay ₹{course.discount_price})
                  </p>
                )}
              </div>
              ...
              <div className="p-6">
                {hasAccess ? (
                  <div className="space-y-4 text-center">
                    ...
                    <h3 className="font-serif text-xl font-semibold text-ink">You are already enrolled!</h3>
                  ...
                  <div className="space-y-4 text-center">
                    <p className="text-sm text-muted">
                      Please log in or create an account to enroll in the course and activate your test schedule.
                    </p>
