  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="/admin/tests" className="text-green-600 px-3 py-2 rounded-md text-sm font-medium">Tests</a>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Manage MCQ Tests</h2>
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
          <p className="text-gray-600">MCQ test management interface will be implemented here.</p>
        </div>
      </div>
    </div>
  );
